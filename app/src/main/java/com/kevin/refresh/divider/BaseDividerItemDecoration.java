...
public class BaseDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    /**
     * 分割线取决于样式中的： <item name="android:listDivider">@drawable/divider</item> 属性
     * @param context
     * @param orientation
     */
    ...
    /**
     * 分割线样式取决用传递的资源id，可以是图片、选择器
     * @param context
     * @param orientation
     * @param resId
     */
    public BaseDividerItemDecoration(Context context, int orientation,int resId) {
